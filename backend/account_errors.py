...
ACCOUNT_ERROR_MESSAGES = {
    ...
    "ACCOUNT_EMAIL_REQUIRED": {"zh-CN": "请填写邮箱", "en": "Email is required"},
    ...
    "ACCOUNT_PHONE_REQUIRED": {"zh-CN": "请选择国家并填写手机号", "en": "Country and phone number are required"},
    ...
    "ACCOUNT_GENDER_INVALID": {"zh-CN": "请选择有效的性别选项", "en": "Select a supported gender option"},
    "ACCOUNT_BIRTH_DATE_INVALID": {"zh-CN": "请选择有效且不晚于今天的生日", "en": "Enter a valid birth date that is not in the future"},
    "ACCOUNT_SIGNATURE_TOO_LONG": {"zh-CN": "个性签名不能超过 160 个字符", "en": "The signature cannot exceed 160 characters"},
    ...
    "SHARE_EXPIRED": {"zh-CN": "分享码已过期，请联系分享者重新生成", "en": "This share code has expired. Ask the sender to create a new one"},
    "SHARE_CLOSED": {"zh-CN": "分享已被关闭，请联系分享者重新启用或生成新分享", "en": "This share was closed. Ask the sender to reopen it or create a new share"},
    "SHARE_NO_AVAILABLE_ITEMS": {"zh-CN": "该分享中没有当前可加入购物车的内容", "en": "This share has no items currently available to add"},
    "QUOTE_NOT_FOUND": {"zh-CN": "报价单不存在、已撤回或无权查看", "en": "The quotation was not found, was withdrawn, or is unavailable to this account"},
    "QUOTE_RECIPIENT_REQUIRED": {"zh-CN": "无法识别报价接收账号，请选择客户后再发送", "en": "Select a customer account before sending the quotation"},
    "QUOTE_RECIPIENT_UNAVAILABLE": {"zh-CN": "所选接收账号不存在、已停用或已归档", "en": "The selected recipient account is missing, disabled, or archived"},
    "QUOTE_DELIVERY_NOT_FOUND": {"zh-CN": "没有可撤回的报价发送记录", "en": "No active quotation delivery was found to withdraw"},
    "QUOTE_ARCHIVED": {"zh-CN": "报价单已归档，不能继续修改或发送", "en": "The quotation is archived and cannot be changed or sent"},
    "QUOTE_NOT_ARCHIVED": {"zh-CN": "该报价单未归档，不能恢复", "en": "This quotation is not archived and cannot be restored"},
    "QUOTE_DELETE_FORBIDDEN": {"zh-CN": "已发送或已归档的报价单不能永久删除，请使用撤回或归档", "en": "A sent or archived quotation cannot be deleted. Withdraw or archive it instead"},
    "QUOTE_VERSION_CONFLICT": {"zh-CN": "报价单已在其他窗口修改，请重新加载后再操作", "en": "The quotation changed in another window. Reload it and try again"},
    "QUOTE_SOURCE_ALREADY_EXISTS": {"zh-CN": "该来源已有你的有效报价，请先打开或归档原报价", "en": "You already have an active quote for this source. Open or archive it first"},
    "INQUIRY_CART_EMPTY": {"zh-CN": "购物车为空，暂时无法提交询价", "en": "Your cart is empty, so an inquiry cannot be submitted"},
    "INQUIRY_CONFIGURATION_INVALID": {"zh-CN": "当前设备选配不完整或已失效，请重新检查后提交", "en": "The current device configuration is incomplete or unavailable. Review it before submitting"},
    "INQUIRY_PRODUCT_NOT_FOUND": {"zh-CN": "该设备已被删除，请返回设备目录重新选择", "en": "This product was removed. Return to the product catalog and select another product"},
    "INQUIRY_PRODUCT_INACTIVE": {"zh-CN": "该设备已停用，暂时不能提交询价，请重新选择或联系销售", "en": "This product is inactive and cannot be submitted. Select another product or contact sales"},
    "INQUIRY_COLOR_UNAVAILABLE": {"zh-CN": "所选外观颜色已不可用，请重新选择颜色后提交", "en": "The selected color is unavailable. Select another color and submit again"},
    "INQUIRY_OPTION_UNAVAILABLE": {"zh-CN": "部分已选配置已停用或删除，请重新选择后提交", "en": "Some selected options are inactive or removed. Review the selection and submit again"},
    "INQUIRY_CART_ITEM_UNAVAILABLE": {"zh-CN": "购物车中有内容已被移除或无权访问，请刷新购物车后重试", "en": "A cart item was removed or is no longer accessible. Refresh the cart and try again"},
    "INQUIRY_DUPLICATE_REQUEST": {"zh-CN": "该询价正在处理，请不要重复提交", "en": "This inquiry is already being processed. Do not submit it again"},
    "INQUIRY_NOT_FOUND": {"zh-CN": "询价记录不存在或已被移除", "en": "The inquiry record was not found or was removed"},
    "INQUIRY_ACCESS_DENIED": {"zh-CN": "无权查看或操作该询价", "en": "You do not have permission to access this inquiry"},
    "INQUIRY_ALREADY_CANCELLED": {"zh-CN": "该询价已经取消", "en": "This inquiry has already been cancelled"},
    "INQUIRY_STATUS_CONFLICT": {"zh-CN": "询价状态已变化，请重新加载后再操作", "en": "The inquiry status changed. Reload it and try again"},
    "INQUIRY_STATUS_TRANSITION_INVALID": {"zh-CN": "询价不能回退到所选状态，请刷新后按当前流程继续", "en": "The inquiry cannot move back to that status. Refresh it and continue from its current state"},
    "INQUIRY_ASSIGNEE_UNAVAILABLE": {"zh-CN": "所选业务员不存在、已停用或已归档", "en": "The selected sales user is missing, disabled, or archived"},
    "INQUIRY_QUOTE_ALREADY_EXISTS": {"zh-CN": "该询价已经有关联报价草稿", "en": "This inquiry already has a linked quotation draft"},
    "INQUIRY_SNAPSHOT_INVALID": {"zh-CN": "询价历史配置无法解析，请由业务员人工处理", "en": "The inquiry snapshot cannot be parsed and needs manual sales handling"},
