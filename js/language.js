(function () {
  ...
  const copy = {
    zh: {
      ...
      appearance: "外观颜色", shareSelected: "分享", exportCombinedPdf: "导出 PDF",
    ...
    en: {
      ...
      appearance: "Appearance", shareSelected: "Share", exportCombinedPdf: "Export PDF",
  ...
  function applyStaticLanguage(lang) {
    ...
    const catalogStageToggleLabel = document.getElementById("catalog-stage-toggle-label");
