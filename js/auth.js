...
const AUTH_ERROR_COPY = {
  ...
  SHARE_NOT_FOUND: ["分享码不存在，请核对六位分享码后重试。", "The share code was not found. Check the six-digit code and try again."],
  SHARE_EXPIRED: ["分享码已过期，请联系分享者重新生成。", "This share code has expired. Ask the sender to create a new one."],
  SHARE_CLOSED: ["分享已被关闭，请联系分享者重新启用或生成新分享。", "This share was closed. Ask the sender to reopen it or create a new share."],
