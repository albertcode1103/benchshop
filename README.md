...
用户端不显示或接收任何设备、配置、工具和附件价格；配置 PDF 同样不含价格。价格数据继续保存在数据库和历史快照中，仅供管理员/业务员在分享详情、报价编辑、后台分享 PDF 和正式报价 PDF 中使用。当前执行状态与验收入口见 [`docs/2026-09-04-project-master-plan.md`](docs/2026-09-04-project-master-plan.md)。
